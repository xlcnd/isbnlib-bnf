...
def test_query():
    ...
    assert (len(repr(query('9782072693144'))) > 100) == True
    assert (len(repr(query('9782247169092'))) > 100) == True
    assert (len(repr(query('9782210760851'))) > 100) == True
...
def test_metadata():
    ...
    if os.getenv('GITHUB_OS', ''):
        return True
    assert (len(repr(meta('9782210760851', service='bnf'))) > 100) == True
...
def test_quirk():
    ...
    if os.getenv('GITHUB_OS', ''):
        return True
    assert (len(repr(query('2800121335'))) > 100) == True
    assert (len(repr(meta('2800121335', service='bnf'))) > 100) == True
